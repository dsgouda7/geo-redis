...
impl Config {
    pub fn from_env() -> Self {
        Self {
            ...
            // Use WEATHER_POLL_SECS to avoid picking up POLL_INTERVAL_SECS=30
            // from the shared root .env (Open-Meteo updates hourly; 15 min is plenty).
            poll_interval_secs: env_parse("WEATHER_POLL_SECS", 900u64),
