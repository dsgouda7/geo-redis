...
//        kubectl port-forward -n proxima svc/geo-node-0 4000:4000
//        kubectl port-forward -n proxima svc/geo-node-1 4001:4001
//        kubectl port-forward -n proxima svc/geo-node-2 4002:4002
//        kubectl port-forward -n proxima svc/geo-node-3 4003:4003
...
/// address (e.g. "geo-node-3.proxima.svc.cluster.local:4003"), since the
